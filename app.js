(() => {
  ...
  function translationUrl(itemOrSlug, canonical = true) {
    ...
    if (canonical) return new URL(`https://zx87s.github.io/translations/${encodeURIComponent(slug)}/`);
  ...
  function setAdminTab(tab) {
    ...
    $("#admin-audit-panel").hidden = tab !== "audit";
    if (tab === "audit") { auditCursors = [null]; loadAudit(null); }
    if (tab === "reports") loadAvatarReports();
  }
